    ...
    if (t.items.len > 1) {
        ...
        if (t.items.len == 2) {
            ...
            for (1..t.items.len - 2) |i| {
                ...
                try colorize_text.append(new_middle);
            }
